...
class CashierMenuMinumanAdapter(private val id_transaksi: Long ,private val trxViewModel: CashierViewModel): ListAdapter<Menu, CashierMenuMinumanAdapter.ViewHolder>(PRODUCTS_COMPARATOR) {
