...
class AdminMenuMinumanAdapter(private val listener: ClickListener, private val menuViewModel: AdminMenuViewModel): ListAdapter<Menu, AdminMenuMinumanAdapter.ViewHolder>(
    ...
    inner class ViewHolder(private val binding: RvCardMenuBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdminMenuMinumanAdapter.ViewHolder {
        val binding = RvCardMenuBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AdminMenuMinumanAdapter.ViewHolder, position: Int) {
